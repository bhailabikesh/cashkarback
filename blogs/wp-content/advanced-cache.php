...
$nitropack_functions_file = '/home/gadgetzc/cashkar.in/blogs/wp-content/plugins/nitropack/functions.php';
$nitropack_abspath = '/home/gadgetzc/cashkar.in/blogs/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_fb57e2c93cc0cd91ae2a5f6e50cf8e90' );
