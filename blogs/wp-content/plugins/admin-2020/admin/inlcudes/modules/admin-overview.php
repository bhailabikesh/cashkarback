	...
	*/
	...
	public function add_menu_item() {
		...
		if(get_bloginfo( 'name' )){
			$name = get_bloginfo( 'name' ) . ' ' .  __('Overview','admin2020');
		} else {
			$name =  __('UiPress Overview','admin2020');
		}
		
		add_menu_page( $name, __('Overview',"admin2020"), 'read', 'uip-overview', array($this,'build_overview'),'dashicons-chart-bar', 0 );
		return;
