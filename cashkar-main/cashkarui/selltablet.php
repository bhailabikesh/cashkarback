    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="bg-transparent breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sell Tablet</li>
            </ol>
        </nav>

        <div class="banner__jumbotron">
            <div class="row">
                <div class="mx-auto mb-4 col-lg-6 col-sm-10">
                    <h2 class="mb-5 banner__jumbotron--title">Sell Old Tablet</h2>
                    ...
                    <h4 class="banner__jumbotron--choose">
                        <span>or Choose Gadget Brand</span>
                    </h4>

                    <div class="banner__jumbotron--brand">
                        <div class="box">
                    ...
                    <div  class="banner__jumbotron--btn-more">
                        <a href="listtablet.php">See All Brands</a>
                    </div>
                </div>

                <div class="mx-auto mb-4 col-lg-4 col-sm-10 d-none d-md-block">
                    <div class="banner__jumbotron--img">
            ...
            <div class="owl-carousel owl-theme testimonial__carousel--theme items-container">
                <div class="item">
                    <div class="border-0 card top-sell__card" data-mh="top-sell">
                        <img src="img/tablet1.webp" alt="" class="top-sell__carousel--img">
