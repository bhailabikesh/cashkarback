    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="bg-transparent breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sell Laptop</li>
            </ol>
        </nav>
        ...
        <div class="banner__jumbotron">
            <div class="row">
                <div class="mx-auto mb-4 col-lg-6 col-sm-10">
                    <h2 class="mb-5 banner__jumbotron--title">Sell Old Laptop</h2>
                    ...
                    <div  class="banner__jumbotron--btn-more">
                        <a href="listlaptop.php">See All Brands</a>
                    </div>
                </div>
