...
?>
<?php 
// add model starts from here.
if (isset($_REQUEST['action'])) {
    if ($_REQUEST['action'] == 'add') {
       // $modelId = $_REQUEST['mid']; 
        ?>
        <div>
    <h2>Add Model info</h2>
</div>
<?php
if (isset($_REQUEST['Submit'])) {
    ...
    $getDBslug = "SELECT `slug` FROM `model` where slug = '$slug'";
    ...
    $number = rand(1000,25000);
    $getDBcode = "SELECT modelCode FROM `model` where slug = '$number'";
    $queryCode = mysqli_query($connect,$getDBcode);
    $rowCode = mysqli_num_rows($queryCode);
     if($rowCode > 0){
        $mCode = rand(1000,25000);
    }else{
       $mCode = $number;
    }
    
    // $sqlModelUpdate = "INSERT INTO `model`(`price`) VALUES ('$price')";
    ...
    if ($querySqlModel) {
        ...
        header("location:models.php?action=add&success=true");
        // echo "We are Unable to redirect you so please click <a href='models.php'><h1>here</h1></a>";
    } else {
        header("location:models.php?action=add&success=false");
    }
} ?>
<div class="col-lg-12">
    <div class="card">
        <div class="card-header"><strong>Model</strong><small> Add</small></div>
        <div class="card-body card-block">
            <form method="post" enctype="multipart/form-data" autocomplete="off">
               ...
               <div class="col-lg-6 col-sm-12 col-12" style='border-right:1px solid black;'>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="brand" placeholder="Brand name" name="brand" class="form-control">
                </div>
                <div class="form-group">
                    <label for="modelName" class=" form-control-label">Model Name</label>
                    <input type="text" id="modelName" name="model" placeholder="Model name" class="form-control">
                </div>
                <div class="form-group">
                    <label for="price" class=" form-control-label">Price</label>
                    <input type="text" id="price" placeholder="Enter price" name="price" class="form-control">
                </div>
                ...
                <div class="form-group" id="storage">
                    ...
                    <input type="text" id="storage" placeholder="Enter Storage Details" name="storage" class="form-control">
                ...
                <div class="form-group" id="ram">
                    ...
                    <input type="text" id="ram" placeholder="Enter RAM Detail" name="ram" class="form-control">
                ...
                <div class="form-group" id="alt">
                    ...
                    <input type="text" id="alt" placeholder="Enter alt keyword" name="alt" class="form-control">
            ...
            <div class="col-lg-6 col-sm-12 col-12">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="moreThanSix" placeholder="Enter deduction Rate for it." name="0To3Warranty" class="form-control" max-lenght="2">
                </div>
                <div class="form-group">
                    <label for="lessThanSix" class=" form-control-label">Warranty : 3 To 6 Months</label>
                    <input type="number" id="lessThanSix" name="3To6Warranty" placeholder="Enter deduction " class="form-control">
                </div>
                <div class="form-group">
                    <label for="lessThanSix" class=" form-control-label">Warranty : 6 To 11 Months</label>
                    <input type="number" id="lessThanSix" name="6To11Warranty" placeholder="Enter deduction " class="form-control">
                </div>
                <div class="form-group">
                    <label for="noWarranty" class=" form-control-label">Warranty: No Warranty</label>
                    <input type="number" id="noWarranty" placeholder="Enter Deduction rate for it" name="noWarranty" class="form-control">
                </div><hr>
                <div class="form-group">
                    <label for="scratchless" class=" form-control-label">Body Conditon: Scratchless</label>
                    <input type="number" id="scratchless" name="scratchlessBody" placeholder="Enter deduction" class="form-control">
                </div>
                <div class="form-group">
                    <label for="good" class=" form-control-label">Body Condition: Good</label>
                    <input type="number" id="good" name="goodBody" placeholder="Enter deduction" class="form-control">
                </div>
                <div class="form-group">
                    <label for="average" class=" form-control-label">Body Condition: Average</label>
                    <input type="number" id="average" name="averageBody" placeholder="Enter deduction" class="form-control">
                </div>
                <div class="form-group">
                    <label for="bellowAverage" class=" form-control-label">Body Condition: Bellow Average</label>
                    <input type="number" id="bellowAverage" name="bellowAverageBody" placeholder="Enter deduction" class="form-control">
                </div><hr>
                <div class="form-group">
                    <label for="scratchlessScreen" class=" form-control-label">Screen Conditon: Scratchless</label>
                    <input type="number" id="scratchlessScreen" name="scratchlessScreen" placeholder="Enter deduction" class="form-control">
                </div>
                <div class="form-group">
                    <label for="crackedScreen" class=" form-control-label">Screen Conditon: Cracked</label>
                    <input type="number" id="crackedScreen" name="crackedScreen" placeholder="Enter deduction" class="form-control">
                </div>
                <div class="form-group">
                    <label for="blankScreen" class=" form-control-label">Screen Conditon: Blank/ Not Working</label>
                    <input type="text" id="blankScreen" name="blankScreen" placeholder="Enter Deduction" class="form-control">
                </div>
                <div class="form-group">
                    <label for="lines_spotScreen" class=" form-control-label">Screen Conditon: Lines/Spots/DC</label>
                    <input type="number" id="lines_spotScreen" name="lines_spotScreen" placeholder="Enter deduction" class="form-control">
                </div>
                <div class="form-group">
                    <label for="scratchScreen" class=" form-control-label">Screen Conditon: Scretches On Screen</label>
                    <input type="number" id="scratchScreen" name="scratchScreen" placeholder="Enter deduction " class="form-control">
                </div><hr>
                <div class="form-group">
                    <label for="fCamera" class=" form-control-label">Not Working: Front Camera</label>
                    <input type="number" id="fCamera" name="fCamera" placeholder="Enter deduction" class="form-control">
                </div>
                <div class="form-group">
                    <label for="bCamera" class=" form-control-label">Not Working: Back Camera</label>
                    <input type="number" id="bCamera" name="bCamera" placeholder="Enter deduction" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="battery" class=" form-control-label">Not Working: Battery</label>
                    <input type="number" id="battery" name="battery" placeholder="Enter deduction" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="fingerSensor" class=" form-control-label">Not Working: Finger Sensor</label>
                    <input type="number" id="fingerSensor" name="fingerSensor" placeholder="Enter deduction" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="faceID" class=" form-control-label">Not Working: Face ID</label>
                    <input type="number" id="faceID" name="faceID" placeholder="Enter deduction" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="bluetooth" class=" form-control-label">Not Working: Bluetooth/Wi-Fi</label>
                    <input type="number" id="bluetooth" name="bluetooth" placeholder="Enter deduction" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="bentPhone" class=" form-control-label">Bent Phone</label>
                    <input type="number" id="bentPhone" name="bentPhone" placeholder="Enter deduction" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="displayChanged" class=" form-control-label">Display Changed</label>
                    <input type="number" id="displayChanged" name="displayChanged" placeholder="Enter deduction" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="speakerProblem" class=" form-control-label">Speaker Problem</label>
                    <input type="number" id="speakerProblem" name="speakerProblem" placeholder="Enter deduction" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="mic" class=" form-control-label">MIC Problem</label>
                    <input type="number" id="mic" name="mic" placeholder="Enter deduction " class="form-control">
                </div>
                 <div class="form-group">
                    <label for="network" class=" form-control-label">Network Problem</label>
                    <input type="number" id="network" name="network" placeholder="Enter deduction" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="charging" class=" form-control-label">Charging Problem</label>
                    <input type="number" id="charging" name="charging" placeholder="Enter deduction " class="form-control">
                </div>
                <div class="form-group">
                    <label for="bckGlass" class=" form-control-label">Broken Back Glass</label>
                    <input type="number" id="bckGlass" name="brokenBackGlass" placeholder="Enter deduction " class="form-control">
                </div>
                <hr>
                   <div class="form-group">
                    <label for="NanCharger" class=" form-control-label">Accessories: Not Having Charger</label>
                    <input type="number" id="NanCharger" name="NanCharger" placeholder="Enter deduction Amount" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="NanEarphones" class=" form-control-label">Accessories: Not Having Earphones</label>
                    <input type="number" id="NanEarphones" name="NanEarphones" placeholder="Enter deduction Amount" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="NanBox" class=" form-control-label">Accessories: Not Having Box</label>
                    <input type="number" id="NanBox" name="NanBox" placeholder="Enter deduction Amount" class="form-control">
                </div>
                 <div class="form-group">
                    <label for="NanBill" class=" form-control-label">Accessories: Not Having Bill</label>
                    <input type="number" id="NanBill" name="NanBill" placeholder="Enter deduction Amount" class="form-control">
                </div><hr>
             ...
             <div class="form-group">
                <input type="submit" name="Submit" id="country" value="submit" class="form-control btn btn-primary">
            </div>
            </form>
    ...
    // ends add model section
    else {
//starts edit model section....
...
if (isset($_REQUEST['Submit'])) {
  ...
  $sqlModelUpdate = "UPDATE `model` SET `brand`= '$brandName',`model_name`='$modelName',`img`='$imageName',`alt`='$alt',`ram`='$ram',`price`= '$price',`storage`='$storage',`0To3Warranty`='$warranty0To3',`3To6Warranty`='$warranty3To6',`6To11Warranty` = '$warranty3To6',`noWarranty`='$noWarranty',`scratchlessBody`='$scratchLessBody',`good`='$goodBody',`average`='$averageBody',`bellowAverage`='$bellowAverage',`screenScratchless`='$scratchLessscreen',
                    `crackedScreen`='$crackedScreen',`blank/notWorking`='$blankScreen',`lines/spots/dc`='$linesOnScreen',`scratchesOnScreen`='$scratches',`frontCamera`='$frontCamera',`backCamera`='$backCamera',`battery`='$battery',`fingerSensor`='$fingerSensor',`faceId`='$faceID',`bluetooth/wifi`='$bluetooth',`bentPhone`='$bentPhone',
                `displayChanged`='$displayChanged',`speakerProblem`='$speaker',`MICproblem`='$mic',`networkProblem`='$network',`chargingProblem`='$charging',`backGlassBroken` = '$brokenBackGlass',`notHavingCharger`='$notHavingCharger',`notHavingEarphones`='$notHavingEarphone',`notHavingBox`='$notHavingBox',`notHavingBill`='$notHavingBill' WHERE `id` = '$modelId'";
    $querySqlModel = mysqli_query($connect, $sqlModelUpdate);
    // print_r($sqlModelUpdate);
    if ($querySqlModel) {
        if(isset($_FILES['files'])){
