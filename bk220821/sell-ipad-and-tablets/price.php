<?php
   ...
   if (!(isset($_GET['brand']) and isset($_GET['model']))) {
       header("location:https://cashkar.in/sell-ipad-tablets/");
   } else {
   ...
   <head>
    ...
    //   include "../keywords.php";
      ...
      if($isParent == '1'){
         ...
         ?> Online For Best Price | Sell Used iPad/Tablet At Cashkar" />
         ...
         ?> and free home pickup when you sell your used ipad/tablet at cashkar." />
      ...
      if(isset($_GET['question'])){
         ...
         ?> Online | Sell Old iPad & Tablet For Cash </title>
          <?php
      ...
      <title>Sell Used <?php
         ...
         ?> Online | Best Price For Used iPad/tablet At Cash Kar</title>
         <?php } ?>
          <?php
      }else{
          // for variant model
         ...
         ?> Online For Best Price | Sell Old iPad/Tablet At Cashkar" />
         ...
         ?> and free home pickup. Sell your old iPad/tablet at cashkar." />
               <meta name="description" content="<?php echo $dsc;?>Sell <?php
         $modelNameTxt = explode('-', $_GET['model']);
         for ($i = 0; $i < count($modelNameTxt); $i++) {
             if($i > 0){
             echo $showModelName = ucfirst($modelNameTxt[$i]) . ' ';
      ...
      if(isset($_GET['question'])){
         ...
         ?> Online | Sell Old iPad/Tablet At Cash Kar</title>
          <?php
      ...
      <title>Sell Old <?php
         ...
         ?> For Cash | Best Price For Old iPad/Tablet At Cashkar</title>
         <?php } 
      }
      ?>
  ...
  <link rel="shortcut icon" href="https://cashkar.in/images/Cashkar Website Logo.png" type="image/x-icon">
   ...
   <body>
      ...
      <div class="container p-0">
         <h3 class="p-1 font-size">
             <a href="https://cashkar.in" class="text-decorataion-none text-dark">
                 Home</a> >
            <span class="breadCrums"><a href="https://cashkar.in/sell-ipad-and-tablets" class="text-decorataion-none text-dark">Select Brand </a></span> > <span class="breadCrums"><a href="https://cashkar.in/ipad-and-tablets/<?php echo $brandSlug;?>" class="text-decorataion-none text-dark">Select Model </a></span>><span class="breadCrums"> Select Variant</span>
         </h3>
         <div class="col-12 mx-auto mt-5 row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 p-1">
               <img src="https://cashkar.in/images/model/ipad-tablets/<?php echo $img; ?>" alt="<?php echo $alt; ?>" class="img-fluid">
            </div>
            <div class="col-lg-8 col-md-8 col-sm-12 p-0">
               <div class="col-lg-11 col-sm-12 m-auto p-0">
                  ...
                  <div class="d-flex center flex-wrap m-auto row p-0">
                     ...
                     <div class="col-12">
                        <ul class="storage-selector-list">
                            ...
                            ?>
                            <li class="shadow" id="<?php echo $internalStorage;?>"><a href="https://cashkar.in/sell-old-ipad-tablets/sell-<?php echo $brandName.'/'.$urlModel;?>" class="text-decoration-none btn-active-link"><?php echo $showStorage;?></a></strong></li>
                           <?php
                        }
                     ...
                     <!-- btn -->
                     </div><style>.storage-selector-list {list-style: none;display:flex;justify-content:center;}.storage-selector-list>li {display:flex;align-items:center;margin: 0.25rem;padding:8px 16px;width:fit-content;background:#eee;;outline:none;cursor: pointer;border-radius:10px;}.storage-selector-list>li::before {content: " ";background: darkgray;width: 1.4rem;height: 1.4rem;border-radius: 50%;display: inline-block;line-height: 1.4rem;color: white;text-align: center;margin-right: 0.5rem;}.active-selected-storage{border: 2px solid #b3d01e!important;}.active-selected-storage::before{background: #b3d01e!important;}.btn-active-link, btn-active-link:hover{color:unset!important;}</style>
                     <?php
                        }
                  ...
                  <center>
                     <a href="https://cashkar.in/sell-old-ipad-tablets/<?php echo $slugBrand;?>/<?php echo $modelSlug;?>/1">
                     <button class="btn-value btn-active p-3 text-btn mr-3 border-radius-15">Get Accurate Value</button>
                     </a>
                  </center>
               </div>
            </div>
         ...
         function checkVariantPrice(data) {
             ...
             ajaxVariationSwitch.onreadystatechange = function() {
                 if (ajaxVariationSwitch.readyState == 4 && ajaxVariationSwitch.status == 200) {
                    ...
                    window.location.href = 'https://cashkar.in/sell-old-ipad-tablets/sell-<?php echo $brandName;?>/'+ajaxVariationSwitch.responseText;
                 }
             };
         }
      </script>
    <!-- question section starts -->
      ...
      <script>
         window.onload = function() {
             ...
             checkAccessories.open("GET", "https://cashkar.in/ajax/does-switchon.php?setSession=false&unset=all", "TRUE");
      ...
      <div class="container">
         <div class="col-lg-10 col-sm-12 mx-auto mt-4">
            <h1 class="text-center mb-4">Selling Your <?php $modelNameTxt = explode('-', $_GET['model']);
       for ($i = 0; $i < count($modelNameTxt); $i++) {
         echo  $showModelName = ucfirst($modelNameTxt[$i]) . ' ';
       } ?></h1>
            <h3 class="text-center mb-4 font-quicksand" style="font-weight:600;color:var(--orange)">Does Your Device Switch on Successfully <i class="fa fa-question-circle"></i></h3>
      ...
      <div class="container">
       ...
       for ($i = 0; $i < count($modelNameTxt); $i++) {
         echo  $showModelName = ucfirst($modelNameTxt[$i]) . ' ';
            ...
            <div>
            <h3 class="text-center mb-4 font-quicksand" style="font-weight:600;color:var(--orange)">Select Screen Condition <i class="fa fa-question-circle"></i></h3>
            <div class="row center">
               <div class="col-lg-3 col-sm-3 col-6 mx-auto mb-3 d-flex center">
                  <button value="8" type="button" id="section2-q1" class="mb-2 btn-value btn-price px-4 py-2 text-btn mr-3 border-radius-15 border-black-2 btn-square" onclick="screenConditon1(this.value);">
                  Flawless Screen
                  </button>
               ...
               <div class="col-lg-3 col-sm-4 mx-auto mb-3 col-6 d-flex center flex-column">
                  <button value="12" type="button" id="section2-q2" class="mb-2 btn-value btn-price px-3 py-2 text-btn mr-3 border-radius-15 border-black-2 btn-square" onclick="screenConditon2(this.value);">
                  Scratches On Screen
                  </button>
                  <!--<p class="info-txt text-center txt-underline mb-2">What's this?</p>-->
               </div>
               <div class="col-lg-3 col-sm-4 mx-auto mb-3 col-6  d-flex center">
                  <button value="11" type="button" id="section2-q3" class="mb-2 btn-value btn-price px-4 py-2 text-btn mr-3 border-radius-15 border-black-2 btn-square" onclick="screenConditon3(this.value);">
                  Cracked Screen
                  </button>
                  <!--<p class="info-txt text-center txt-underline mb-2">What's this?</p>-->
               </div>
               <div class="col-lg-3 col-sm-4 col-6 mx-auto mb-2 d-flex center">
                  <button value="9" type="button" id="section2-q4" class="mb-2 btn-value btn-price px-4 py-2 text-btn mr-3 border-radius-15 border-black-2 btn-square" onclick="screenConditon4(this.value);">
                  Faulty Screen
                  </button>
                  <!--<p class="info-txt text-center txt-underline mb-2">What's this?</p>-->
               </div>
      ...
      <div class="container">
       ...
       for ($i = 0; $i < count($modelNameTxt); $i++) {
         echo  $showModelName = ucfirst($modelNameTxt[$i]) . ' ';
            ...
            <h3 class="text-center font-quicksand mb-4" style="font-weight:600;color:var(--orange)">Select Device Functionality <i class="fa fa-question-circle"></i></h3>
      ...
      <div class="container">
       ...
       for ($i = 0; $i < count($modelNameTxt); $i++) {
         echo  $showModelName = ucfirst($modelNameTxt[$i]) . ' ';
            ...
            <h3 class="text-center font-quicksand mb-4" style="font-weight:600;color:var(--orange)">Select Overall Body Condition <i class="fa fa-question-circle"></i></h3>
            <div class="row center">
               <?php
                  if (isset($_SESSION['0-3']) || isset($_SESSION['3-6'])) {
                  ?>
               <div class="col-lg-3 col-sm-3 col-6 mx-auto mb-3">
                  <button value="flawless" type="button" id="section4-q1" class="mb-2 btn-value btn-price px-4 py-2 text-btn mr-3 border-radius-15 border-black-2 btn-square" onclick="bodyCondition1(this.value);">
                  Flawless
                  </button>
                  <!--<p class="info-txt text-center txt-underline mb-0">What's this?</p>-->
               </div>
               ...
               <div class="col-lg-3 col-sm-4 mb-3 col-6 mx-auto">
                  <button value="good" type="button" id="section4-q2" class="mb-2 btn-value btn-price px-4 py-2 text-btn mr-3 border-radius-15 border-black-2 btn-square" onclick="bodyCondition2(this.value);">
                  Good
                  </button>
                  <!--<p class="info-txt text-center txt-underline mb-0">What's this?</p>-->
               </div>
               <div class="col-lg-3 col-sm-4 mx-auto col-6 mb-3">
                  <button value="average" type="button" id="section4-q3" class="mb-2 btn-value btn-price px-4 py-2 text-btn mr-3 border-radius-15 border-black-2 btn-square" onclick="bodyCondition3(this.value);">
                  Average
                  </button>
                  <!--<p class="info-txt text-center txt-underline mb-0">What's this?</p>-->
               </div>
               <div class="col-lg-3 col-sm-4 col-6 mx-auto mb-3">
                  <button value="bellowAverage" type="button" id="section4-q4" class="mb-2 btn-value btn-price px-4 py-2 text-btn mr-3 border-radius-15 border-black-2 btn-square" onclick="bodyCondition4(this.value);">
                  Below Average
                  </button>
                  <!--<p class="info-txt text-center txt-underline mb-0">What's this?</p>-->
               </div>
            ...
            <div class="col-lg-5 col-sm-10 mx-auto mt-4">
               ...
               <label for="backglass">Check if back glass is broken</label>
            </div>
            <div class="row" hidden id="properties">
               <div class="col-lg-3 col-sm-3 col-6 m-auto p-3 border-dashed">
                  <div class="container-fluid">
            ...
            <div class="col-11 d-flex space-between mt-3 mx-auto pt-2">
               <button class="btn btn-warning" id="prev" onclick="goBack(5)">
      ...
      <div class="container">
       ...
       for ($i = 0; $i < count($modelNameTxt); $i++) {
         echo  $showModelName = ucfirst($modelNameTxt[$i]) . ' ';
            ...
            <h3 class="text-center font-quicksand mb-4" style="font-weight:600;color:var(--orange)">Select Accessories You Have<i class="fa fa-question-circle"></i><h3>
            <div class="row center">
               <div class="col-lg-3 col-sm-3 col-6 mx-auto mb-3">
               ...
               <div class="col-lg-3 col-sm-4 col-6 mx-auto">
                  <button value="Bill" type="button" id="section5-q4" class="mb-2 btn-value  btn-price px-4 py-2 text-btn mr-3 border-radius-15 border-black-2 btn-square" onclick="accessories(this.id);">
                  Bill
                  </button>
               </div>
            </div>
            ...
            <div class="col-11 d-flex mt-3 mx-auto pt-2 d-flex space-between">
               ...
               << Previous </button> 
               <button class="btn btn-warning" disabled id="nxt" onclick="nextIndir(5)"> Next >>
               </button>
            </div>
         </div>
      </div>
     ...
     <style type="text/css">
      ...
      <script>
                            var activeStorage = '<?php echo $selectStorage;?>';
                            console.log(activeStorage);
                            const selectorOption = document.getElementById(activeStorage);
                            selectorOption.classList.add('active-selected-storage');
                        </script>
   </body>
</html>