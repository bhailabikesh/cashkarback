...
<html lang="en">
   <head>
      ...
      <meta property="og:title" content="Sell Used Old Laptop Online | Best Price For Used <?php echo ucwords($brandName); ?> Laptop | Cash-Kar" />
      <meta property="og:description" content="Sell your used <?php echo ucwords($brandName); ?> Laptop. Sell old <?php echo ucwords($brandName); ?> laptop and get instant cash." />
      <meta property="og:url" content="https://www.cashkar.in/sell-laptop" />
  ...
  <link rel="shortcut icon" href="https://cashkar.in/images/Cashkar Website Logo.png" type="image/x-icon">
      ...
      <meta name="description" content="Sell <?php echo ucwords($brandName); ?> phone online. Sell Used <?php echo ucwords($brandName); ?> laptop at Cash Kar & Get Best Value, Free pickup & Instant Cash." />
      ...
      <title>Sell <?php echo ucwords($brandName); ?> Laptop Online | Best Price For Used <?php echo ucwords($brandName); ?> Laptop</title>
   </head>
   <body>
      <div class="container-fluid p-0">
         ...
         <h3 class="p-1 font-size ml-5"><a href="https://cashkar.in/" class="text-dark text-decoration-none">Home </a>>
            <span class="breadCrums"><a href="https://cashkar.in/sell-laptop" class="text-dark text-decoration-none">Select Brand </a> </span> > <span class="breadCrums"><a href="#" class="text-warning text-decoration-none">Select Model </a> </span>
         </h3>
         <div class="container sell-header-top d-flex flex-column col-lg-6 col-sm-12 mx-auto my-4">
            <div class="heading-txt-sell mt-4 d-flex flex-column font-quicksand">
               <h1 class="text-uppercase font-size-20 text-center">
                  Sell Old <?php echo ucwords($brandName); ?> Laptop Online.
                  <br>
                  Best Price & Instant Cash For Used <?php echo ucwords($brandName); ?> Laptop.
               </h1>
               <br>
         ...
         <div class="container">
            ...
            <div class="row">
               <?php
                  $getModel = "SELECT * FROM laptopmodel where brand ='$brandName' and isParent = 1 and category = 'laptop' ORDER BY id desc";
               ...
               <div class="col-lg-3 col-md-3 col-sm-6 col-6 mb-2 pr-2 mb-2">
                  <div class="model-box">
                     <a href="https://cashkar.in/sell-old-laptop/<?php echo $brandName;?>/<?php echo $slug;?>" class="text-decoration-none">
                        <img src="https://cashkar.in/images/model/laptop/<?php echo $img; ?>" width="100%" height="auto" alt="<?php echo $alt; ?>">
...
<html lang="en">
   <head>
       <?php
    //   keywords for sell laptop home page
      ...
      <meta http-equiv="X-UA-Compatible" content="IE=Edge" />
      <meta name="format-detection" content="telephone=no" />
      <meta property="og:title" content="Sell Old Phone Online | Get Cash For Old Phone | Cashkar" />
      <meta property="og:description" content="Sell used phone for instant cash. Sell your old laptop smartphone for best price, free hoe pickup & instant cash at Cash-Kar." />
      <meta property="og:url" content="https://www.cashkar.in/sell-laptop" />
      <meta property="og:type" content="website" />
      <link rel="shortcut icon" href="https://cashkar.in/images/Cashkar Website Logo.png" type="image/x-icon">
      <meta property="og:site_name" content="Cashkar" />
      <meta name="description" content="Sell old phone online for cash. Sell your used laptop at cashkar and get best value, free home pickup and instant cash." />
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <!-- meta tags ends here -->
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
      <!-- jQuery library -->
      ...
      <title>Sell Old Phone Online | Sell Old laptop For Cash At Cashkar</title>
   </head>
   <body>
      <div class="container-fluid p-0">
         <!-- include header navigation bar -->
         ...
         <div class="container sell-header-top d-flex flex-column col-lg-6 col-sm-12 mx-auto my-4">
            <div class="heading-txt-sell mt-4 d-flex flex-column font-quicksand">
               <h1 class="text-uppercase font-size-20 text-center">
                  Sell Old iPhone & Android Phone Online To Get Instant Cash
               </h1>
               <br>
               <div class="input-icons">
                  <i class="fa fa-search icon"></i>
         ...
         <div class="container">
            ...
            <div class="row mx-auto" id="searchMbl">
               <div class="col-lg-3 col-md-3 col-sm-4 col-6 mb-3 d-flex center">
                  <a href="\select-laptop-brand/sell-apple">
                  <img src="https://cashkar.in/sell-mobile/images/brands/Apple.png" class="brand-img" alt="Sell Apple iPhone On Cashkar">
                  </a>
               </div>
               <div class="col-lg-3 col-md-3 col-sm-4 col-6 mb-3 d-flex center">
                  <a href="\select-laptop-brand/sell-samsung">
                  <img src="https://cashkar.in/sell-mobile/images/brands/Samsung.png" class="brand-img" alt="">
                  </a>
               </div>
            </div>
         </div>
